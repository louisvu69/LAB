...
public class EmployeeManagementController {
    ...
    public void displayAndSortBySalary() {
        ...
        Collections.sort(employeeManager.getEmployeesList(), (Employee s1, Employee s2) -> Double.compare(s1.getSalary(), s2.getSalary()));
        for (Employee e : employeeManager.getEmployeesList()) {
